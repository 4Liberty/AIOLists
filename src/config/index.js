...
const METADATA_BATCH_SIZE = 50; // Increased from default 10
const POSTER_BATCH_SIZE = 50; // Increased from default 25
const TRAKT_CONCURRENT_REQUESTS = 50; // Increased concurrency
const TMDB_CONCURRENT_REQUESTS = 50; // Increased concurrency for better performance
const MDB_LIST_CONCURRENT_REQUESTS = 50; // New batch setting
